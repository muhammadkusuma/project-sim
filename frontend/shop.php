...
<head>
    ...
    <link rel="stylesheet" href="asset-index/css/templatemo.css">
    <link rel="stylesheet" href="asset-index//css/custom.css">

    <!-- Load fonts style after rendering the layout styles -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;200;300;400;500;700;900&display=swap">
    <link rel="stylesheet" href="asset-index/css/fontawesome.min.css">
...
<body>
    ...
    <!-- menampilkan foto, obat , harga, stok dari database -->
        ...
        <div class="row">
            ...
            ?>
                <div class="col-md-4 mt-2">
                    <div class="card">
                        <img src="/frontend/img/<?= $data['foto_obat']; ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title
                            "><?php echo $data['nama_obat']; ?></h5>
                            <p class="card-text">Rp. <?php echo number_format($data['harga_obat']); ?></p>
                            <p class="card-text">Stok : <?php echo $data['stok_obat']; ?></p>
    ...
    <script src="asset-index/js/jquery-migrate-1.2.1.min.js"></script>
    <script src="asset-index/js/bootstrap.bundle.min.js"></script>
    <script src="asset-index/js/templatemo.js"></script>
