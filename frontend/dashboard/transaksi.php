                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped" id="table1">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = query("SELECT * FROM transaksi where id_pendaftar='$a'");
                                                // $sql1 = query("SELECT * from pengirim where id_pendaftar='$a'");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php
                                                        $b = $_SESSION['id'];
                                                        $sql1 = query("SELECT * from penerima where id_pendaftar='$b'");
                                                        // var_dump($sql1);
                                                        ?>
                                                        <td><?php echo $sql1[0]['nama_penerima']; ?></td>
                                                        <td><?php echo $sql1[0]['alamat_penerima']; ?></td>
                                                        <td><?php echo $sql1[0]['no_telp_penerima']; ?></td>
